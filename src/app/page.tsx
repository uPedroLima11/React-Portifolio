  ...
  return (
    <div>
      ...
      <section className="flex items-center justify-between py-48 px-6 md:px-32 space-y-10 w-full">
        ...
        <Image src="/static/MinhaFoto.png" alt='eu' width={250} height={10} className=' mr-14 -rotate-6' />
      </section>
      <div className="flex justify-end -mt-80 mr-[11rem] gap-10">
        <div className="mt-14 -mr-4"><Link href='https://www.linkedin.com/in/upedrolima/'><Image src="/static/linkedin.png" alt="linkedin" width={50} height={50} className='py-14' /></Link></div>
        <div className="mt-14 -mr-3"><Link href='https://www.instagram.com/upedro_lima/'><Image src="/static/instagram1.png" alt='linkedin' width={50} height={50} className='py-14' /></Link></div>
        <div className="mt-14 "><Link href='https://github.com/uPedroLima11'><Image src="/static/github.png" alt='linkedin' width={50} height={50} className='py-14' /></Link>
        </div><div id="sobremim"></div>
      </div>
      <section className="p-12">
        <div className="flex justify-center"> <h1 className="text-3xl font-bold">Sobre Mim</h1></div>
        <div className="mt-32 ml-12"> <Image src="/static/linguagens.png" alt="sobremim"  width="450" height="400" className="rounded-xl border-4 border-[#101013]" />
        </div>
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <Image src="/static/typescript.png" alt="typescript" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <Image src="/static/react.png" alt="react" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <Image src="/static/javascript.png" alt="javascript" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <Image src="/static/tailwind.png" alt="tailwind" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        <div className="absolute inset-0 border-2 border-transparent rounded-lg loading-border-blue"></div>
        <Image src="/static/mysql1.png" alt="mysql1" width={60} height={40} className="mt-20" />
        <p className="text-white font-bold mt-10">MySQL</p>
      </div>

      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        <div className="absolute inset-0 border-2 border-transparent rounded-lg loading-border-cyan"></div>
        <Image src="/static/python.png" alt="react" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <Image src="/static/git.png" alt="nodejs" width={60} height={40} className="mt-20" />
      ...
      <div className="relative pb-24 bg-[#1a1a1f] mb-10 flex flex-col items-center justify-center rounded-lg py-2 px-4 hover:scale-105 transition delay-150 duration-150 ease-in-out shadow-lg flex-grow overflow-hidden">
        ...
        <img src="/static/wireframe.png" alt="test" width={60} height={40} className="mt-20" />
